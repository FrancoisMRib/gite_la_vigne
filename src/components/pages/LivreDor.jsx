export function LivreDor() {
    return (
        <div>
            ...
            <p>Martine et Gulles (Hautes-Alpes)</p>
            <p>Séjout du 15 au 29 septembre 2022</p>
            ...
            <p>2e séjour dans cette maison toujours aussi agréable ! <br/> Très bien située pour aller aux Thermes en 10 minutes <br/> Un grand merci à Myriam pour son accueil (sa fouace aveyronnaise et son jus de fruit...)<br/> Poutquoi pas un 3e séjour !!! pour une 3e cure. <br/> 2 curistes Val d'oisiennes</p>
